...
export function MonthlySummaryCard({
  ...
  return (
    <div className="flex w-[473px] shrink-0 flex-col gap-6 rounded-[14px] border border-[rgba(188,230,193,0.55)] bg-white p-8 shadow-[1px_1px_3px_-1px_rgba(0,0,0,0.25)]">
