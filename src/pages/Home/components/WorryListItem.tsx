...
export function WorryListItem({ worry }: WorryListItemProps) {
  ...
  return (
    ...
    <div className="flex flex-wrap items-center gap-4 rounded-[14px] border border-[rgba(188,230,193,0.55)] bg-white p-3 shadow-[1px_1px_3px_-1px_rgba(0,0,0,0.25)] lg:gap-2 lg:p-2 xl:flex-nowrap xl:gap-4 xl:rounded-none xl:border-0 xl:bg-transparent xl:p-0 xl:shadow-none">
      ...
      <div className="flex min-w-20 flex-1 flex-col gap-1.5">
        ...
        <div className="h-2.5 w-full rounded-[7px] bg-[#f5f5f5] xl:h-1.75">
          <div
        ...
        <div className="flex min-w-0 items-center gap-1 text-[10px] text-[#a9d592] xl:text-[13px]">
          ...
          <span className="truncate">{formatRemainingTime(worry.remainingSeconds)} 남음</span>
        </div>
      </div>
      ...
      {canExtendTimer && (
        ...
        >
          <Plus className="h-3 w-3 lg:h-2.5 lg:w-2.5 xl:h-3.5 xl:w-3.5" />
          타이머 늘리기
        </button>
      )}
    </div>
